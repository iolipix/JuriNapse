  ...
  const calculateTrendingScore = (post: any) => {
    ...
    if (post.comments && post.comments.length > 0) {
      post.comments.forEach((comment: any) => {
        ...
        const hoursOld = (now.getTime() - commentDate.getTime()) / (1000 * 60 * 60);
    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex items-center space-x-2 sm:space-x-3 mb-2">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Tendances</h1>
        </div>
      ...
      <div className="space-y-4 sm:space-y-6">
        {trendingPosts.length === 0 ? (
          <div className="text-center py-8 sm:py-12">
            ...
            <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-2">Aucune tendance</h3>
            ...
            <div key={post.id} className="relative">
              ...
              {index < 3 && (
                <div className="absolute -top-2 -left-2 z-10">
                  <div className={`flex items-center space-x-1 px-2 sm:px-3 py-1 rounded-full text-xs font-bold text-white shadow-lg ${
