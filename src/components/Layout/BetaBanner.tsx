...
const BetaBanner: React.FC<BetaBannerProps> = ({ 
  ...
  if (variant === 'animated') {
    return (
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white shadow-sm border-b border-blue-300 overflow-hidden relative sticky top-16 z-40">
