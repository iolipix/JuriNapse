...
// Récupérer tous les posts d'un utilisateur par son username avec pagination
const getUserPostsByUsername = async (req, res) => {
  try {
    ...
    // Récupérer les posts de cet utilisateur avec pagination
...
// Récupérer les statistiques d'un utilisateur par son username (nombre de posts, likes totaux, etc.)
const getUserStatsByUsername = async (req, res) => {
  try {
    ...
    // Récupérer le post le plus récent pour avoir des infos complémentaires
