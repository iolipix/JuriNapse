...
router.get('/user/:userId/followers', authenticateToken, subscriptionController.getUserFollowers);
router.get('/user/:userId/following', authenticateToken, subscriptionController.getUserFollowing);
