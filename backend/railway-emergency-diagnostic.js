...
try {
  ...
  console.log('✅ Controllers directory exists (../controllers)');
  ...
  try {
    const currentControllersPath = path.join(process.cwd(), 'controllers');
    const currentFiles = fs.readdirSync(currentControllersPath);
    console.log('✅ Controllers directory exists (./controllers)');
    ...
    console.log('❌ Error reading ./controllers directory:', currentError.message);
  }
}
...
try {
  ...
  if (fs.existsSync(routesPath)) {
    ...
    console.log('✅ ../routes/auth.routes.js exists');
    ...
    console.log('❌ ../routes/auth.routes.js does not exist');
  }
} catch (error) {
  console.log('❌ Error checking ../routes/auth.routes.js:', error.message);
}
